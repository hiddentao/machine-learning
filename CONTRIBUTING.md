...
This guide guidelines for those wishing to contribute to the machine-learning package.

## Contributor license agreement

By submitting code as an individual or as an entity you agree that your code is [licensed the same as machine-learning](LICENSE.md).
